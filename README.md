...
The **qTESLA** library implements the lattice-based digital signature scheme qTESLA. This signature scheme is conjectured to be secure against quantum computer attacks.

Concretely, the qTESLA library includes the following schemes:
...
The library was developed by Microsoft Research using as basis the [`qTESLA implementation`](https://github.com/qtesla/qTesla) developed by the qTESLA team and submitted to NIST's Post-Quantum Cryptography Standardization process.
